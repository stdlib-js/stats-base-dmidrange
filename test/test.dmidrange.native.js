...
var dmidrange = tryRequire( resolve( __dirname, './../lib/dmidrange.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( dmidrange.length, 3, 'has expected arity' );
	t.end();
});
