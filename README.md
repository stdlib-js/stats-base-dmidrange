...
```javascript
dmidrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmidrange@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmidrange@umd/bundle.js"></script>
```
